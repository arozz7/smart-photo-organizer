...
For each extraction:
1. **Create Destination:** Write the new file with all necessary imports.
2. **Export:** Ensure the function/class is exported.
3. **Verify:** Confirm the new file compiles/looks correct.
4. **Update Original:** ONLY change the original file to import the new module.
